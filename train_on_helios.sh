...
export DATA_DIR=$SVHN_DIR
export TMP_DATA_DIR=$DATA_DIR
export TMP_RESULTS_DIR=$DATA_DIR
# export METADATA_FILENAME=$SVHN_DIR'/train_extra_metadata.pkl'
export METADATA_FILENAME=$ROOT_DIR'/data/SVHN/train_extra_metadata_split.pkl'
